...
{
	$('div.main_data').block({ message: '<img src="optimum/images/preloader.gif" style="height:25px;" />' }); 
	$.ajax({
		url: url,
...
function delete_data(delete_url , post_refresh_url)
{
	...
	$('#preloader-delete').html('<img src="optimum/images/preloader.gif" style="height:15px;margin-top:-10px;" />');
