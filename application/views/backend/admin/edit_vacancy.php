...
<?php echo form_open(base_url(). 'admin/vacancy/update/' . $vacancy['vacancy_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
