<div class="row">
        ...
        <?php echo form_open(base_url(). 'admin/book/create' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
               ...
               foreach($select_book as $key => $book):
                ...
                ?>
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>admin/book/delete/<?php echo $book['book_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
