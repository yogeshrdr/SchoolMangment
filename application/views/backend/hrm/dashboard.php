 <!--row -->
            <div class="row">
                ...
                <div class="row">
                    ...
                    <?php $select_award = $this->db->get('award')->result_array(); //$this->crud_model->get_invoice_info();
                            foreach ($select_award as $key => $award_selected):?>

                                {
                                "country": "<?php echo $award_selected['name'];?>",
                                "litres": <?php echo $award_selected['amount'];?>
                                }, 
                    <?php endforeach;?>
