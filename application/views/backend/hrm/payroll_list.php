<?php echo form_open(base_url() . 'hrm/payroll_list/filter'); ?>
...
<hr>
    ...
    <table class="table table-bordered">
     ...
     <?php if($row['status']== 0){ ?>
      <a href="<?php echo base_url(); ?>hrm/payroll_list/mark_paid/<?php echo $row['payroll_id'];?>/<?php echo $month;?>/<?php echo $year;?>" class="btn btn-primary btn-rounded btn-sm" style="color:#fff"><i class="fa fa-check"></i> <?php echo get_phrase('mark_as_paid'); ?></a>
     <?php } ?>    
                    </td>
                </tr>
<?php endforeach;?>
