...
<div class="row">
    ...
    <div class="col-md-2">
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>hrm/application/applied" 
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>hrm/application/on_review" 
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>hrm/application/interviewed" 
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>hrm/application/offered" 
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>hrm/application/hired" 
        ...
        <a style="text-align: left;" href="<?php echo base_url();?>hrm/application/declined" 
    ...
    <div class="col-md-10">
            ...
            foreach ($select_application as $key => $applicant):?>
                    ...
                    <a href="#" class="btn btn-danger btn-circle btn-xs" onclick="confirm_modal('<?php echo base_url(); ?>hrm/application/delete/<?php echo $applicant['application_id'];?>');">
