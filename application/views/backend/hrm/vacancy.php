...
<?php echo form_open(site_url('hrm/vacancy/insert'), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
    ...
    $counter = 1; foreach($select_vacancy as $key => $vacancy):?>
            ...
            <tr>
				...
				<a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/edit_vacancy/<?php echo $vacancy['vacancy_id'];?>');" 
                     ...
                     <a href="#" class="btn btn-xs btn-circle btn-danger" onclick="confirm_modal('<?php echo base_url(); ?>hrm/vacancy/delete/<?php echo $vacancy['vacancy_id'];?>');">
