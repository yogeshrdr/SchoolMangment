...
<?php echo form_open(base_url() . 'librarian/publisher/create', array('class' => 'form-horizontal form-goups-bordered validate'));?>
...
<div class="panel-wrapper collapse in" aria-expanded="true">
				...
				<thead>
                		...
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo get_phrase('publisher_name');?></div></th>
                    ...
                    foreach ($select_publisher as $key => $publisher): ?>
                        <tr>
                            ...
                            <a href="<?php echo base_url();?>librarian/publisher/delete/<?php echo $publisher['publisher_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
